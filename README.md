...
local SliderJumpPower_Roundify_4px = Instance.new("ImageLabel")
...
TextLabel_6.Parent = RGBWaterButton
...
TextButton_Roundify_4px_7.Name = "TextButton_Roundify_4px"
...
HipHeightInner.Name = "HipHeightInner"
...
-- Scripts:
	...
	local HipHeightCount = script.Parent.UronesMain.PlayerFrame.SliderHipHeight.HipHeightCount
	...
	TeleportButton.MouseButton1Down:Connect(function()
		TeleportButton1.ImageTransparency = 0.5
		wait(0.01)
		TeleportButton1.ImageTransparency = 0.3
		wait(0.01)
		TeleportButton1.ImageTransparency = 0
		
		local tp_namedplayer = TeleportBox.Text
		local tp_player = game:GetService("Players")[tp_namedplayer]
		local PLR = game:GetService("Players").LocalPlayer
		local p = TeleportBox.Text
	...
	--- Owl Hub ---
	local OwlHub = script.Parent.UronesMain.PlayerFrame.OwlHubButton
	local OwlHub1 = script.Parent.UronesMain.PlayerFrame.OwlHubButton.TextButton_Roundify_4px
	...
	local colourDarkTween = tweenService:Create(OwlHub1, tweenInfo, {ImageColor3 = Color3.fromRGB(247, 22, 56)})
	local colourBrightTween = tweenService:Create(OwlHub1, tweenInfo, {ImageColor3 = Color3.fromRGB(170, 14, 40)})
	local colourDefaultTween = tweenService:Create(OwlHub1, tweenInfo, {ImageColor3 = Color3.fromRGB(247, 22, 56)})
	
	OwlHub.MouseEnter:Connect(function()
	
		colourBrightTween:Play()
	end)
	
	OwlHub.MouseLeave:Connect(function()
	...
	OwlHub.MouseButton1Down:Connect(function()
		OwlHub1.ImageTransparency = 0.5
		wait(0.01)
		OwlHub1.ImageTransparency = 0.3
		wait(0.01)
		OwlHub1.ImageTransparency = 0
	...
	--- Anti Afk ---
	local AntiAFK = script.Parent.UronesMain.PlayerFrame.AntiAfkButton
	local AntiAFK1 = script.Parent.UronesMain.PlayerFrame.AntiAfkButton.TextButton_Roundify_4px
	...
	local colourDarkTween = tweenService:Create(AntiAFK1, tweenInfo, {ImageColor3 = Color3.fromRGB(247, 22, 56)})
	local colourBrightTween = tweenService:Create(AntiAFK1, tweenInfo, {ImageColor3 = Color3.fromRGB(170, 14, 40)})
	local colourDefaultTween = tweenService:Create(AntiAFK1, tweenInfo, {ImageColor3 = Color3.fromRGB(247, 22, 56)})
	
	AntiAFK.MouseEnter:Connect(function()
	
		colourBrightTween:Play()
	end)
	
	AntiAFK.MouseLeave:Connect(function()
	...
	AntiAFK.MouseButton1Down:Connect(function()
		AntiAFK1.ImageTransparency = 0.5
		wait(0.01)
		AntiAFK1.ImageTransparency = 0.3
		wait(0.01)
		AntiAFK1.ImageTransparency = 0
	...
	--- God Mode ---
	local GodMode = script.Parent.UronesMain.PlayerFrame.GodModeButton
	local GodMode1 = script.Parent.UronesMain.PlayerFrame.GodModeButton.TextButton_Roundify_4px
	...
	local colourDarkTween = tweenService:Create(GodMode1, tweenInfo, {ImageColor3 = Color3.fromRGB(247, 22, 56)})
	local colourBrightTween = tweenService:Create(GodMode1, tweenInfo, {ImageColor3 = Color3.fromRGB(170, 14, 40)})
	local colourDefaultTween = tweenService:Create(GodMode1, tweenInfo, {ImageColor3 = Color3.fromRGB(247, 22, 56)})
	...
	GodMode.MouseButton1Down:Connect(function()
		GodMode1.ImageTransparency = 0.5
		wait(0.01)
		GodMode1.ImageTransparency = 0.3
		wait(0.01)
		GodMode1.ImageTransparency = 0
	...
	PlayerFrame.RGBWaterButton.MouseEnter:Connect(function()
		PlayerFrame.RGBWaterButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.RGBWaterButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.RGBWaterButton.ButtonOFF.ImageTransparency = 0
	end)
	
	PlayerFrame.RGBWaterButton.MouseLeave:Connect(function()
		PlayerFrame.RGBWaterButton.ButtonOFF.ImageTransparency = 0
		wait(0.01)
		PlayerFrame.RGBWaterButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.RGBWaterButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.RGBWaterButton.ButtonOFF.ImageTransparency = 0.9
		wait(0.01)
		PlayerFrame.RGBWaterButton.ButtonOFF.ImageTransparency = 1
	end)
	
	PlayerFrame.RGBWaterButton.ButtonOFF.MouseButton1Down:Connect(function()
		PlayerFrame.RGBWaterButton.ButtonOFF.Visible = false
		PlayerFrame.RGBWaterButton.ButtonON.Visible = true
		_G.RGBWater = true
		while _G.RGBWater do
			wait(0.1)
			workspace.Terrain.WaterColor = Color3.fromHSV(tick() * 24 % 255/255, 1, 1)
		end
	end)
	
	PlayerFrame.RGBWaterButton.ButtonON.MouseButton1Down:Connect(function()
		PlayerFrame.RGBWaterButton.ButtonOFF.Visible = true
		PlayerFrame.RGBWaterButton.ButtonON.Visible = false
		_G.RGBWater = false
		wait(0.1)
	...
	PlayerFrame.RGBWorldButton.MouseEnter:Connect(function()
		PlayerFrame.RGBWorldButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.RGBWorldButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.RGBWorldButton.ButtonOFF.ImageTransparency = 0
	end)
	
	PlayerFrame.RGBWorldButton.MouseLeave:Connect(function()
		PlayerFrame.RGBWorldButton.ButtonOFF.ImageTransparency = 0
		wait(0.01)
		PlayerFrame.RGBWorldButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.RGBWorldButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.RGBWorldButton.ButtonOFF.ImageTransparency = 0.9
		wait(0.01)
		PlayerFrame.RGBWorldButton.ButtonOFF.ImageTransparency = 1
	end)
	
	PlayerFrame.RGBWorldButton.ButtonOFF.MouseButton1Down:Connect(function()
		PlayerFrame.RGBWorldButton.ButtonOFF.Visible = false
		PlayerFrame.RGBWorldButton.ButtonON.Visible = true
		function zigzag(X) return math.acos(math.cos(X*math.pi))/math.pi end
	
		counter = 0
	
		_G.RainbowW = true
		while _G.RainbowW do
			wait(0.001)
			game.Lighting.Ambient = Color3.fromHSV(zigzag(counter),1,1)
			game.Lighting.ColorShift_Bottom = Color3.fromHSV(zigzag(counter),1,1)
			game.Lighting.ColorShift_Top = Color3.fromHSV(zigzag(counter),1,1)
			counter = counter + 0.01
		end
	end)
	
	PlayerFrame.RGBWorldButton.ButtonON.MouseButton1Down:Connect(function()
		PlayerFrame.RGBWorldButton.ButtonOFF.Visible = true
		PlayerFrame.RGBWorldButton.ButtonON.Visible = false
		_G.RainbowW = false
		wait(0.01)
		game.Lighting.Ambient = Color3.fromHSV(0, 0, 0)
		game.Lighting.ColorShift_Bottom = Color3.fromHSV(0, 0, 0)
		game.Lighting.ColorShift_Top = Color3.fromHSV(0, 0, 0)
	end)
	...
	PlayerFrame.SpamChatButton.MouseEnter:Connect(function()
		PlayerFrame.SpamChatButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.SpamChatButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.SpamChatButton.ButtonOFF.ImageTransparency = 0
	end)
	
	PlayerFrame.SpamChatButton.MouseLeave:Connect(function()
		PlayerFrame.SpamChatButton.ButtonOFF.ImageTransparency = 0
		wait(0.01)
		PlayerFrame.SpamChatButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.SpamChatButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.SpamChatButton.ButtonOFF.ImageTransparency = 0.9
		wait(0.01)
		PlayerFrame.SpamChatButton.ButtonOFF.ImageTransparency = 1
	end)
	
	PlayerFrame.SpamChatButton.ButtonOFF.MouseButton1Down:Connect(function()
		PlayerFrame.SpamChatButton.ButtonOFF.Visible = false
		PlayerFrame.SpamChatButton.ButtonON.Visible = true
		_G.SpamChat = true
		while _G.SpamChat do
			wait(0.1)
			local A_1 = ": URONES HUB IS FREE  :" local A_2 = "All" 
			local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) end
	end)
	
	PlayerFrame.SpamChatButton.ButtonON.MouseButton1Down:Connect(function()
		PlayerFrame.SpamChatButton.ButtonOFF.Visible = true
		PlayerFrame.SpamChatButton.ButtonON.Visible = false
		_G.SpamChat = false
	end)
	...
	PlayerFrame.FullbrightButton.MouseEnter:Connect(function()
		PlayerFrame.FullbrightButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.FullbrightButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.FullbrightButton.ButtonOFF.ImageTransparency = 0
	end)
	
	PlayerFrame.FullbrightButton.MouseLeave:Connect(function()
		PlayerFrame.FullbrightButton.ButtonOFF.ImageTransparency = 0
		wait(0.01)
		PlayerFrame.FullbrightButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.FullbrightButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.FullbrightButton.ButtonOFF.ImageTransparency = 0.9
		wait(0.01)
		PlayerFrame.FullbrightButton.ButtonOFF.ImageTransparency = 1
	end)
	
	PlayerFrame.FullbrightButton.ButtonOFF.MouseButton1Down:Connect(function()
		PlayerFrame.FullbrightButton.ButtonOFF.Visible = false
		PlayerFrame.FullbrightButton.ButtonON.Visible = true
	...
	PlayerFrame.FullbrightButton.ButtonON.MouseButton1Down:Connect(function()
		PlayerFrame.FullbrightButton.ButtonOFF.Visible = true
		PlayerFrame.FullbrightButton.ButtonON.Visible = false
		if not _G.FullBrightExecuted then
	...
	PlayerFrame.InfinityJumpButton.MouseEnter:Connect(function()
		PlayerFrame.InfinityJumpButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.InfinityJumpButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.InfinityJumpButton.ButtonOFF.ImageTransparency = 0
	end)
	
	PlayerFrame.InfinityJumpButton.MouseLeave:Connect(function()
		PlayerFrame.InfinityJumpButton.ButtonOFF.ImageTransparency = 0
		wait(0.01)
		PlayerFrame.InfinityJumpButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.InfinityJumpButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.InfinityJumpButton.ButtonOFF.ImageTransparency = 0.9
		wait(0.01)
		PlayerFrame.InfinityJumpButton.ButtonOFF.ImageTransparency = 1
	end)
	
	PlayerFrame.InfinityJumpButton.ButtonOFF.MouseButton1Down:Connect(function()
		PlayerFrame.InfinityJumpButton.ButtonOFF.Visible = false
		PlayerFrame.InfinityJumpButton.ButtonON.Visible = true
	...
	PlayerFrame.InfinityJumpButton.ButtonON.MouseButton1Down:Connect(function()
		PlayerFrame.InfinityJumpButton.ButtonOFF.Visible = true
		PlayerFrame.InfinityJumpButton.ButtonON.Visible = false
	...
	PlayerFrame.AnchoredButton.MouseEnter:Connect(function()
		PlayerFrame.AnchoredButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.AnchoredButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.AnchoredButton.ButtonOFF.ImageTransparency = 0
	end)
	
	PlayerFrame.AnchoredButton.MouseLeave:Connect(function()
		PlayerFrame.AnchoredButton.ButtonOFF.ImageTransparency = 0
		wait(0.01)
		PlayerFrame.AnchoredButton.ButtonOFF.ImageTransparency = 0.3
		wait(0.01)
		PlayerFrame.AnchoredButton.ButtonOFF.ImageTransparency = 0.5
		wait(0.01)
		PlayerFrame.AnchoredButton.ButtonOFF.ImageTransparency = 0.9
		wait(0.01)
		PlayerFrame.AnchoredButton.ButtonOFF.ImageTransparency = 1
	end)
	
	PlayerFrame.AnchoredButton.ButtonOFF.MouseButton1Down:Connect(function()
		PlayerFrame.AnchoredButton.ButtonOFF.Visible = false
		PlayerFrame.AnchoredButton.ButtonON.Visible = true
		game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = true
	end)
	
	PlayerFrame.AnchoredButton.ButtonON.MouseButton1Down:Connect(function()
		PlayerFrame.AnchoredButton.ButtonOFF.Visible = true
		PlayerFrame.AnchoredButton.ButtonON.Visible = false
